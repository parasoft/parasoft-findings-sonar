...
public class SonarLocationMatcher
    extends DefaultLocationMatcher
{
    ...
    @Override
    public ITestableInput matchLocation(ITestableInput originalInput, List<Long> hashes, String sRepositoryPath, String sBranch,
