...
public class ParasoftDottestAndCpptestTestsParser {
    ...
    private int parseInt(String value) {
        ...
        } catch (Exception e) { // parasoft-suppress OWASP2021.A5.NCE "This is intentionally designed to ensure exceptions during int parsing don't cause the process to fail." // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during int value parsing don't cause the process to fail."
            return 0;
        }
    }
